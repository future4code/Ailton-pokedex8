...
export const objectTypes = {
  poison: { img: poison, color: "#AD61AE" },
  grass: { img: grass, color: "#70B873" },
  fire: { img: fire, color: "#F44900" },
  flying: { img: flying, color: "#6892B0" },
  water: { img: water, color: "#33A4F5" },
  bug: { img: bug, color: "#316520" },
  normal: { img: normal, color: "#8A8A8A" },
  dark: { img: dark, color: "#5C5365" },
  dragon: { img: dragon, color: "#0A6CBF" },
  electric: { img: electric, color: "#F4D23B" },
  fairy: { img: fairy, color: "#EC8FE6" },
  fighting: { img: fighting, color: "#CE4069" },
  ghost: { img: ghost, color: "#5269AC" },
  ground: { img: ground, color: "#D97745" },
  ice: { img: ice, color: "#74CEC0" },
  psychic: { img: psychic, color: "#F67176" },
  rock: { img: rock, color: "#C7B78B" },
  steel: { img: steel, color: "#BBBBBB" },
};
